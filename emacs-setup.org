...
- Things that reflect environment should be in custom (if possible - variables that are simple), possibly using =(custom-theme-set-variables 'user...= to use expression.
